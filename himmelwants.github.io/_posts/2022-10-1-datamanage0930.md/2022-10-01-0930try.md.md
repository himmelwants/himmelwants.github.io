...
● where condition
select 데이터명 from 테이블명 where 조건(데이터 항목=데이터)
where 조건문을 통해서 원하는 데이터
    #김연아 고객의 전화번호를 검색하라
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjA4ODExMzEyMiwtNTY1MDU4NTk3LC0xMj
g5ODg0NzQxLDE5Mjg4MzI0MTksLTQ2MDIwOTk3MSw3MDI2MDk5
OTcsLTE2Mjc2ODMxNjhdfQ==
-->