...
이번 주차에는 데이터베이스에 테이블을 생성하고 각각의 테이블에 데이터 값을 입력하는 방법을 배웠다. 또한 count 함수와 select 문의 기본 문법 중 where  조건문을 활용하여 결과 값을 출력하는 연습을 하였으며, 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTIwNTc0NzA0M119
-->