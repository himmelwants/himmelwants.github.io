...
테이블이름 [WHERE 검색조건];
    ...
    #도서번호 11, 도서명 'Book of World cup', 출판사 'korea books', 가격 22000원인 데이터를 Book 테이블에 추가한 후 해당 도서의 데이터들을 제거하라/delect
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbODE5OTI4MjAzLDE1NDU0NTQ1NjYsLTE0MD
U0NzY2OCw2MjQzMzYyNzgsLTIxMTMzNTUxMTIsMTI1NzEzOTk5
MV19
-->