...
#오늘의 날짜와 요일을 문자열로 출력하라/ yyyy
select date_format(sysdate(), '%Y%m%d' ), 
date_format(sysdate(), '%Y%m%w%a' ) 
from dual;
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0NDkxMjMwMTcsLTEzMDA2MjExMTIsLT
E2ODU5MDU5MjMsMzUxMzU2NzYxLDE1NDU0NTQ1NjYsLTE0MDU0
NzY2OCw2MjQzMzYyNzgsLTIxMTMzNTUxMTIsMTI1NzEzOTk5MV
19
-->