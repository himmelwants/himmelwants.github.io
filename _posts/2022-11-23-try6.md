...
DATE 문자열(STRING) 데이터를 날자형(DATE)으로 반환 STR_TO_DATE('2019-02-14', '%Y-%m-%d') => 2019-02-14

DATE_FORMAT(date, format) 
STRING 날짜형(DATE) 데이터를 문자열(VARCHAR)로 반환 DATE_FORMAT('2019-02-14', '%Y-%m-%d') => '2019-02-14'
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTE2NTA2NTg1NywtMTY4NTkwNTkyMywzNT
EzNTY3NjEsMTU0NTQ1NDU2NiwtMTQwNTQ3NjY4LDYyNDMzNjI3
OCwtMjExMzM1NTExMiwxMjU3MTM5OTkxXX0=
-->