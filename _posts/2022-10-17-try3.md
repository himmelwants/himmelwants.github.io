...
• 도서명은 null 값을 가질 수 없고, 출판사는 같은 값을 가져서는 않된다.

• 가격이 입력되지 않을 경우 기본값 10000을 입력한다. 단, 가격은 최소 1000 이상이다.

    create table A(
    bookname varchar(20) primary key not null,
    publisher varcahr(20) primary key unique,
    price int defult 10000
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTM0NTE3NjcwLDI3MTk1MTY5Nyw2ODYxNz
gwODksLTQwMTg5MzAwMywyNzQ5ODc0NTMsLTE1MzI3ODMzNzgs
Njk1MzQ0Mjc3LC0xMDE5OTA2Nzc2LC0yMjY3NTE1MjRdfQ==
-->