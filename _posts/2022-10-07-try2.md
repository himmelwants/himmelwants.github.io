...
#도서명, 출판사명, 가격 데이터를 검색하여 비싼 가격 순으로 정렬하라  (가격이 동일할 경우 출판사명 순으로 정렬하라/order by)
...
![image](https://user-images.githubusercontent.com/114793024/194695364-f6b80e1a-b4be-46fd-a1c4-53df782d7150.png)
    ...
    #football 관련된 도서만 도서명, 출판사명, 가격을 검색하라 (비싼 도서, 출판사명 순으로 정렬/where like '%word%' - order by)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTg2MDc2NTg1MiwtMTQzNjUzNTM1MSwyMD
M1NjQzNTk4LC00ODE1MzU2MzgsMTM3Mzg0MDM4MSwtMTIyNjg0
NzM4LDYyNjg4NDQyNywtNTU0NzU0MzA2LC0xMjkyMTg1MzMzLC
0xMzA3OTU0NzQ2LDUzNzU0NDQ3MiwxMDQ3MDA3MTQ2LDIwMzQy
NDA3NzksLTk4NjYyMjQ3Nl19
-->